...
)
{
    ...
    this->letterbox_params_.src_width = src_width;
    this->letterbox_params_.src_height = src_height;
    this->letterbox_params_.dst_width = this->config_.input_width;
    this->letterbox_params_.dst_height = this->config_.input_height;
    this->letterbox_params_.scale = scale;
    this->letterbox_params_.pad_x = pad_x;
    this->letterbox_params_.pad_y = pad_y;
